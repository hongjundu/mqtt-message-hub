...
#if defined(HTTPD_LIMITED)
#define HTTP_MAX_URL		1024
#else
#define HTTP_MAX_URL		1024 * 100
#endif
...
typedef	struct {
	...
	char	path[HTTP_MAX_URL],
		...
		ipForwardedFor[HTTP_IP_ADDR_LEN];
#if(0)
...
int httpdModifyVariable __ANSI_PROTO((request*, const char*, const char*));
